...
{
	[XmlType(TypeName = "Scanners.Twain.Settings.ContrastSetting")]
	public class ContrastSetting : Scanners.Twain.Settings.TwainSettingBase
	{
		double value = 0;
		double max = 0;
		double min = 0;
		...
		public ContrastSetting(TwainApp.TwainScanner scanner)
		{
			Load(scanner);
		}
		#endregion
		...
		{
			CopyFrom(scanner.GetCapability((ushort)TwainApp.SharedCap.Icap_CONTRAST));		
		}
		#endregion

		#region CopyFrom()
		public void CopyFrom(ContrastSetting setting)
		{
