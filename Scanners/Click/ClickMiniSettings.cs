...
{
	[Serializable]
	public class ClickMiniSettings
	{
		...
		public Scanners.Click.Settings.ClickMini.ScanModeSetting	ScanMode	{ get; set; }
		public Scanners.Click.Settings.FocusSetting					Focus { get; set; }

   //     public Scanners.Click.Settings.BrightnessSetting            PullSlip_Brightness { get; set; }
		...
		public ClickMiniSettings()
		{
			...
			this.ScanMode = new Settings.ClickMini.ScanModeSetting();
			this.Focus = new Settings.FocusSetting();

  //          this.PullSlip_Brightness = new Scanners.Click.Settings.BrightnessSetting();

            settingsList = new List<Settings.ISetting>() { this.FileFormat, this.ColorMode, this.Brightness, this.Contrast, this.Dpi, this.ScanMode, this.Focus} ; //, this.PullSlip_Brightness };

			foreach (Scanners.Click.Settings.ISetting setting in settingsList)
				setting.Changed += delegate() { this.settingsChanged = true; };
		}

		public ClickMiniSettings(ClickMiniWrapper scanner)
		{
			this.FileFormat = new Scanners.Click.Settings.FileFormatSetting();
			this.ColorMode = new Scanners.Click.Settings.ColorModeSetting();
			this.Brightness = new Scanners.Click.Settings.BrightnessSetting();
		...
		#region CopyFrom()
		public void CopyFrom(ClickMiniSettings clickSettings)
		{
 ...
 //           this.PullSlip_Brightness.CopyFrom(clickSettings.PullSlip_Brightness);
		}
		#endregion

		#region CopyValuesFrom()
		public void CopyValuesFrom(ClickMiniSettings clickSettings)
		{
			...
			//if (this.Dpi.IsDefined) 
                ...
                //if (this.PullSlip_Brightness.IsDefined) 
//                this.PullSlip_Brightness.Value = clickSettings.PullSlip_Brightness.Value;
		}
		#endregion
