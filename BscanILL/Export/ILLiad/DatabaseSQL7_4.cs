...
{
	public class DatabaseSQL7_4 : DatabaseSQLBase, IDatabaseSQL
	{
		#region variables
		...
		#region constructor
		public DatabaseSQL7_4(string sqlServerUri, string databaseName, bool windowsCredentials, string username, string password)
			: base(sqlServerUri, databaseName, windowsCredentials, username, password)
		{
			InitializeComponent();
		}

		public DatabaseSQL7_4()
			: base()
		{
			InitializeComponent();
		}
					...
					else
					{
						...
						if (lendersRow == null)
						{
							...
							if (addedRows > 0)
							{
								...
								lendersRow = ds.LenderAddresses[0];//.FindByLenderStringAddressNumberNVTGC(transactionsRow.LendingLibrary, transactionsRow.LenderAddressNumber, "Lending");
