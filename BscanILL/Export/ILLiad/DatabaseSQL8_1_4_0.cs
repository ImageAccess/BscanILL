...
{
	public partial class DatabaseSQL8_1_4_0 : DatabaseSQLBase, IDatabaseSQL
	{
		#region variables
		...
		#region constructor
		public DatabaseSQL8_1_4_0(string sqlServerUri, string databaseName, bool windowsCredentials, string username, string password)
			: base(sqlServerUri, databaseName, windowsCredentials, username, password)
		{
			InitializeComponent();
		}

		public DatabaseSQL8_1_4_0()
			: base()
		{
			InitializeComponent();
		}
