...
{
	class FrameScanClick : BscanILL.UI.Frames.Shared.FrameClick, IFrameScanScanner
	{
		FrameScan						frameScan;


		#region constructor
		public FrameScanClick(FrameScan frameScan, Scanners.Click.ClickWrapper click, bool isActive)
		...
		public void Scan()
		{
			try
			{
				if (sm.IsPrimaryScannerSelected)
					_scanner.Scan(scanSettings.Click);
				else
			...
			{
				notifications.Notify(this, Notifications.Type.Error, "FrameScanClick, DoScan(): " + ex.Message, ex);
