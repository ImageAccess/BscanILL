...
{
	public class DbArticleFull
	{
		public DbArticleFull()
		{
			this.Scans = new List<DbScanFull>();
			this.Exports = new List<DbExportFull>();
		}
		...
		public virtual IList<DbScanFull>	Scans { get; set; }
		public virtual IList<DbExportFull>	Exports { get; set; }
		...
		public override bool Equals(object obj)
		{
			...
			DbArticleFull article = (DbArticleFull)obj;
